...
<div>
	...
	<form method="get" action="${pageCiontext.request.contextPath}/cart">
	...
	<table>
		<c:forEach items="${cart.cartItems}" var="cartItem" varStatus="status">
			<tr>
				...
				<td id="itemPrice${status.index}"><fmt:formatNumber value="${cartItem.goods.price}" type="CURRENCY"
